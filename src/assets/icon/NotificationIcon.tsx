...
function NotificationIcon({ stroke = '#525252', strokeWidth = 1.5, strokeLinecap = 'round', strokeLinejoin = 'round' }: Props) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d="M11 20.8887C11.5344 21.4825 12.4656 21.4825 13 20.8887"
            stroke={stroke}
            strokeWidth={strokeWidth}
            strokeLinecap={strokeLinecap}
            strokeLinejoin={strokeLinejoin}
